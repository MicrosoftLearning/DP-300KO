...
**전제 조건**: 연습 1에서 사용하는 Azure SQL Database는 모듈 3의 랩에서 만들었습니다. 
...
6. Cloud Shell을 사용한 적이 있는 경우 Cloud Shell 화면의 상위 모서리에 Bash가 표시되어 있는지 확인하십시오. 드롭다운 화살표를 사용하여 PowerShell 또는 Bash 중 하나를 선택할 수 있습니다. 
