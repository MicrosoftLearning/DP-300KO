...
3. 연결 세부 정보 사이드바에서 다음 정보를 입력하여 이전 작업의 PostgreSQL 데이터베이스에 연결합니다.
	...
	- 서버: 작업 1에서 만든 PostgreSQL Server의 이름을 입력합니다. 예를 들어 **dp300-lab02-xx-postgres.database.azure.com**을 클릭할 수 있습니다. Azure Portal의 개요 창에서 서버의 전체 이름을 확인할 수 있습니다. xx는 직접 추가한 문자로 바꿔야 합니다.
