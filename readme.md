...
- **MCT인가요?** - [MCT용 GitHub 사용자 가이드](https://microsoftlearning.github.io/MCT-User-Guide-KO/)를 참조하세요.
...
- Microsoft는 이를 통해 랩에 대한 공동 의식을 가져올 수 있기를 바랍니다. Azure가 변경되는 경우 라이브 강의 중에 가장 먼저 확인하여 랩 소스를 즉시 개선하시기 바랍니다.  동료 MCT에게 도움을 주십시오.
